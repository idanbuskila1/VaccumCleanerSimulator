...
public:
  ...
  void setDirt(const pair<int, int>, int level);
  bool isWall(const pair<int, int>);
  bool isDock(const pair<int, int>);
  void clean(const pair<int, int>);
  // update and clean
  void clean(const pair<int, int>, int dirt);

  bool isUnexploredEmpty();
  bool isUnexplored(const pair<int, int>);
  // check and erase
  void eraseUnexplored(const pair<int, int>);

  // void updateNeighbors();
  void updateNeighbor(Direction dir, pair<int, int>, bool isWall);
